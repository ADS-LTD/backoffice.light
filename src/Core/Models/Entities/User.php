...
class User
{
	 ...
	 * 
	 * @ORM\Column(name="usr_token",length=500,nullable=true)
	 * @var string
	 */
	private $userToken;
	 ...
	 * 
	 * @ORM\Column(name="usr_token_expire_date",type="datetime",nullable=true)
	 * @var \DateTime
	 */
	...
	/**
	 * Retourne la valeur de $userToken
	 *
	 * @return string
	 */
	...
	/**
	 * Définit la valeur de $userToken
	 *
