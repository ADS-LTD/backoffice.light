...
class Transaction implements \JsonSerializable
{
	...
	/**
     * Agence
     * @ORM\ManyToOne(targetEntity=\Digitalis\Core\Models\Entities\Agence::class,cascade={"merge","persist"},inversedBy="transactions")
	 ...
	 * 
	 * @ORM\ManyToOne(targetEntity=\Digitalis\Core\Models\Entities\Entreprise::class,cascade={"merge","persist"}, inversedBy="transactions")
	...
	public function toArray()
	{
		return [
			...
			'entreprise' => !is_null($this->entreprise) ? $this->entreprise->getId() : null,
			'branch' => !is_null($this->agence) ? $this->agence->getId() : null,
